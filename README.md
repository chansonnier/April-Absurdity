...
2) run the command `cd April-Absurdity/game-source; g++ -std=c++11 -o aprilAbsurdity Company.cpp Competitor.cpp Industry.cpp main.cpp Tournament.cpp` to compile the game's files into a single output file called aprilAbsurdity.
